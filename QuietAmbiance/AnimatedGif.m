...
+ (UIImageView *) getAnimationForGifFromFile:(NSString *)animationFile
{
    ...
    [agqo setFile: animationFile]; // this object is only retained by the queueobject, which will be released when loading finishes
...
- (void) asynchronousLoading
{
    ...
    {
    	NSData *data = [NSData dataWithContentsOfFile:[(AnimatedGifQueueObject *) [imageQueue objectAtIndex: 0] file]];
